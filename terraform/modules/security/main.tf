# Security Controls Module - Detection and monitoring for Wiz exercise
# Implements CloudTrail, GuardDuty, Security Hub, and AWS Config
...
resource "aws_s3_bucket" "cloudtrail" {
  bucket        = "${var.environment}-cloudtrail-logs-${local.account_id}"
  force_destroy = true
